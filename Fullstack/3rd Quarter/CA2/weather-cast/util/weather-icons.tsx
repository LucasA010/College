...
export const getIcon = (weatherCode: number, isDay: boolean): ImageSourcePropType => {
  ...
  const icons: Record<WeatherCodes, ImageSourcePropType> = {
    ...
    1: isDay ? require(`@/assets/icons/mainly-clear-sun`) : require(`@/assets/icons/mainly-clear-moon`),                    // Mainly clear
    2: isDay ? require(`@/assets/icons/cloudy-with-sun`) : require(`@/assets/icons/cloudy-with-moon`),                      // Partly cloudy
    ...
    51: isDay ? require(`@/assets/icons/cloudy-with-rain-and-sun`) : require(`@/assets/icons/cloudy-with-rain-and-moon`),   // Drizzle: Light intensity
    53: isDay ? require(`@/assets/icons/cloudy-with-rain-and-sun`) : require(`@/assets/icons/cloudy-with-rain-and-moon`),   // Drizzle: Moderate intensity
    55: isDay ? require(`@/assets/icons/cloudy-with-rain-and-sun`) : require(`@/assets/icons/cloudy-with-rain-and-moon`),   // Drizzle: Dense intensity
    ...
    75: require(`@/assets/icons/heavy-snowy.png`),                                                                          // Snow fall: Heavy intensity
    ...
    95: isDay ? require(`@/assets/icons/storm-with-sun`) : require(`@/assets/icons/storm-with-moon`),                                                                                // Thunderstorm: Slight or moderate
